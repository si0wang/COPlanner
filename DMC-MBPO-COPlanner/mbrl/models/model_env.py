    ...
    def step_w_ovr(
        ...
        with torch.no_grad():
            ...
            (
                ...
                next_model_state,
                ovr_score,
            ) = self.dynamics_model.sample_w_ovr(
                actions,
                model_state,
                deterministic=not sample,
                rng=self._rng,
            ...
            if self._return_as_np:
                ...
                rewards = rewards.cpu().numpy()
                dones = dones.cpu().numpy()
            return next_observs, rewards, dones, next_model_state, ovr_score
    ...
    def step_ensemble(
        ...
        with torch.no_grad():
            ...
            (
                ...
                next_model_state,
                uncertainty
            ) = self.dynamics_model.sample_ensemble(
                actions,
                model_state,
                deterministic=not sample,
                rng=self._rng,
            ...
            if self._return_as_np:
                ...
                rewards = rewards.cpu().numpy()
                dones = dones.cpu().numpy()
            return next_observs, rewards, dones, next_model_state, uncertainty
