...
class ModelTrainer:
    ...
    def train(
        ...
        for epoch in epoch_iter:
            ...
            #     print("iteration: {}, epoch: {}, train_dataset_size: {}, val_dataset_size: {}, model_loss: {}, model_val_score: {}, model_best_val_score: {}".format(
            #         self._train_iteration, epoch, dataset_train.num_stored, dataset_val.num_stored, total_avg_loss, model_val_score, best_val_score.mean()))
