...
class Agent:
    ...
    @abc.abstractmethod
    def act(self, obs: np.ndarray, cfgs, **_kwargs) -> np.ndarray:
    ...
    def mpc_act(self, obs, model, cfgs, is_rollout) -> np.ndarray:
        """Issues an action given an observation.
    ...
    def plan(self, obs: np.ndarray, cfgs, **_kwargs) -> np.ndarray:
        ...
        return self.act(obs, cfgs, **_kwargs)
